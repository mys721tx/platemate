...
from food.models.common import (
    BoxGroup, Food, Ingredient, IngredientList, Photo
)
...
class Manager(base.Manager):
    def setup(self):
        ...
        photos = [
            Photo.factory(
                photo_url="http://www.platebrain.com/pictures/pilot/pilot1.jpg"
            ),
            Photo.factory(
                photo_url="http://www.platebrain.com/pictures/pilot/pilot2.jpg"
            ),
            Photo.factory(
                photo_url="http://www.platebrain.com/pictures/pilot/pilot3.jpg"
            ),
            Photo.factory(
                photo_url="http://www.platebrain.com/pictures/pilot/pilot4.jpg"
            ),
            Photo.factory(
                photo_url="http://www.platebrain.com/pictures/pilot/pilot5.jpg"
            ),
        ]

        boxgroups = [
            BoxGroup.from_json(
                '{"0":{"x1":59,"y1":29,"x2":269,"y2":135,"width":210,"height":106},"1":{"x1":240,"y1":66,"x2":400,"y2":207,"width":160,"height":141},"2":{"x1":129,"y1":137,"x2":332,"y2":274,"width":203,"height":137},"3":{"x1":9,"y1":78,"x2":153,"y2":274,"width":144,"height":196}}',
                photos[0]
            ),
            BoxGroup.from_json(
                '{"0":{"x1":2,"y1":30,"x2":400,"y2":295,"width":398,"height":265}}',
                photos[0]
            )
        ]
        ...
        ingredientlist1 = IngredientList.factory(
            ingredients=[potato, butter, salt], box=boxes[0]
        )
        ingredientlist2 = IngredientList.factory(
            ingredients=[potato], box=boxes[0]
        )
        ...
        self.employee('tag.box_vote').assign(box_groups=boxgroups, )
        ...
        for ingredient in [potato, butter, salt]:
            self.employee('measure.estimate').assign(ingredient=ingredient, )
